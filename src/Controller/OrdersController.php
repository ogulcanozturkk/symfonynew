...
class OrdersController extends AbstractController
{
    ...
    public function new(Request $request,ShopcartRepository $shopcartRepository): Response
    {
        ...
        $userid = $user->getid();
        $total = $shopcartRepository->getUserShopCartTotal($userid);//Shopcart bilgileri kısmı
        //dump($total);
        //die();    //total geliyor.
        ...
        if ($this->isCsrfTokenValid('form-order', $submittedToken)){
            ...
            if ($form->isSubmitted()) {
                ...
                //Kredi kartı bilgilerini ilgili banka servisine gönderebiliriz.onay beklemeliyiz.
