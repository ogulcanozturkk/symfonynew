...
class ProductController extends AbstractController
{
     ...
     */
    public function show(Product $product, $id, ProductRepository $productRepository): Response
    {
    ...
    public function iupdate(Request $request,$id, Product $product): Response
    {
        ...
        try {
            $file->move(
                $this->getParameter('images_directory'), //servis.yaml da tanımladıgımız resim yolu
                $fileName
            );
